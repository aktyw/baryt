...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/hamburger.js":[function(require,module,exports) {
"use strict";
...
function slide() {
  ...
  var sign = this.childNodes[1].childNodes[1];
  sign.classList.toggle('sign-open');
}
},{}],"scripts/form.js":[function(require,module,exports) {
"use strict";
...
},{}],"scripts/observer.js":[function(require,module,exports) {
...
function show() {
  ...
  var indexes = document.querySelectorAll('.fade__index');
  var titles = document.querySelectorAll('.fade__titles');

  var _iterator = _createForOfIteratorHelper(fades),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var fade = _step.value;
...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"node_modules/lightgallery/lightgallery.es5.js":[function(require,module,exports) {
"use strict";
...
var burger = document.querySelector(".hamburger");
var menu = document.querySelectorAll('.accordion__title');
var links = document.querySelectorAll('.navigation__item-link');
var form = document.querySelector(".form");
burger.addEventListener('click', _hamburger.open);
form.addEventListener('submit', _form.default);
menu.forEach(function (item) {
  return item.addEventListener('click', _menu.default);
});
links.forEach(function (link) {
  return link.addEventListener('click', _hamburger.hideMenu);
});
(0, _lightgallery.default)(gallery);
...
tl.fromTo('.title__span--first', {
  ...
  ease: 'expo',
  autoAlpha: 1
}, "-=.7").fromTo('.phone-mobile', {
  opacity: 0
}, {
  autoAlpha: 1
}); // const anime = gsap.timeline(); 
// anime.fromTo()
},{"./hamburger":"scripts/hamburger.js","./menu":"scripts/menu.js","./form":"scripts/form.js","./observer":"scripts/observer.js","gsap":"node_modules/gsap/index.js","lightgallery":"node_modules/lightgallery/lightgallery.es5.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
